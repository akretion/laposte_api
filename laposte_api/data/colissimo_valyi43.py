...
delivery={'date': '10/04/2014', 'carrier_tracking_ref_bar': u'EY0>500000014>6FR', 'carrier_tracking_ref': u'EY 0000 0001 4 FR', 'weight': '16.3'}
...
address={'city': u'Aluminio', 'name': u'Rapha\xebl VALYI', 'zip': u'18825', 'mobile': '', 'street2': '', 'street3': '', 'phone': '', 'street': u'Rua Paulo Dias, 586', 'country_code': u'BR', 'email': ''}

option={'non_machinable': False, 'ar': False, 'nm': True, 'ftd': False}
...
^FO40,345^PR2,2^BCN,230,Y,N,N^FDEY0>500000014>6FR^FS
^FO40,575^GB
468
,3,4^FS
...
^FO30,675^A0,24,28^FDRaphaël VALYI^FS
^FO30,705^FB400,6,2,
^FDRua Paulo Dias, 586
\&
\&^FS
^FO30,755
^FD18825 Aluminio^FS
...
/* only for Y ?*/
^FO30,780^FDTEL: ^FS
^A0,40^FO30,810^FDRaphaël VALYI - BR^FS
^FO0,950^A0B^FDSPECIFIQUE^FS

/* ||| || |||| */
^FO70,880^BCN,230,Y,N,N^FDEY0>500000014>6FR^FS
